...
namespace UI
{
    public sealed class UI_Installer : MonoInstaller
    {
        ...
        [Header("Hint Popup")][SerializeField][LabelText("Pipeline")]
        private HintPopup_Pipeline _hintPopupPipeline;
        ...
        public override void InstallBindings()
        {
            ...
            InstallPopup<PopupShower<HintPopup, IHintPopupPresenter>, HintPopup>(_hintPopupPipeline.Prefab, _hintPopupPipeline.PopupName);
        }
