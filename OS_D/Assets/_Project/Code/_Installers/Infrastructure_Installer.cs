...
namespace Infrastructure
{
    ...
    {
        //[Header("Audio System")][LabelText("Pipeline")]
        //[SerializeField] private AudioSystem_Pipeline _audioSystemPipeline;
        ...
        private void InstallCommands()
        {
            Container
                .Bind<ISaveCommand>()
                .To<SaveStartFinishCommand>()
                .AsSingle();

            Container
                .Bind<ILoadCommand>()
                .To<LoadStartFinishCommand>()
                .AsSingle();
        }
